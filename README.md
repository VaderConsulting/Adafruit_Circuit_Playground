...
All in one library to control Adafruit's Circuit Playground board. Original author: Adafruit. This is my working copy from the Arduino `libraries` tree. Version recorded in `library.properties`: 1.11.4. Upstream: <https://github.com/adafruit/Adafruit_CircuitPlayground>.
